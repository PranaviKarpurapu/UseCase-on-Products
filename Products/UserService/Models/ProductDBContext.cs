        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Products>(entity =>
            {
                entity.HasKey(e => e.Productid)
                    .HasName("PK__Products__2D172D3297D241C8");
            ...
            modelBuilder.Entity<UserDetails>(entity =>
            {
                entity.HasKey(e => e.Userid)
                    .HasName("PK__UserDeta__CBA1B25709757DBA");

                entity.HasIndex(e => e.Contactnumber)
                    .HasName("UQ__UserDeta__DF8655CCD4E74BE8")
                    .IsUnique();

                entity.HasIndex(e => e.Emailid)
                    .HasName("UQ__UserDeta__8734520BC49B4C17")
                    .IsUnique();

                entity.HasIndex(e => e.Username)
                    .HasName("UQ__UserDeta__F3DBC57259772730")
                    .IsUnique();
